...
.get(`/market/priceoverview?appid=${Application.CSGO}&currency=${Currency.USD}&market_hash_name=DoesNotExist500`)
.reply(500, {success: false})
// Non-Existent Item With Status Code 404
.get(`/market/priceoverview?appid=${Application.CSGO}&currency=${Currency.USD}&market_hash_name=DoesNotExist404`)
