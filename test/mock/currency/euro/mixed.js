...
.get(`/market/priceoverview?appid=${Application.CSGO}&currency=${Currency.EUR}&market_hash_name=DoesNotExist500`)
.reply(500, {success: false})
// Non-Existent Item With Status Code 404
.get(`/market/priceoverview?appid=${Application.CSGO}&currency=${Currency.EUR}&market_hash_name=DoesNotExist404`)
.reply(404, {success: false})

// First Valid Item Request
.get(`/market/priceoverview?appid=${Application.CSGO}&currency=${Currency.EUR}&market_hash_name=FirstItem`)
.reply(200, {
    success: true,
    lowest_price: '1,00€',
    volume: '328',
...
.get(`/market/priceoverview?appid=${Application.CSGO}&currency=${Currency.EUR}&market_hash_name=SecondItem`)
.reply(200, {
    success: true,
    lowest_price: '2,00€',
    volume: '612',
