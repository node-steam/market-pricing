...
.get(`/market/priceoverview?currency=${Currency.EUR}&appid=${Application.CSGO}&market_hash_name=DoesNotExist500`)
.reply(500, {success: false})
// Non-Existent Item With Status Code 404
.get(`/market/priceoverview?currency=${Currency.EUR}&appid=${Application.CSGO}&market_hash_name=DoesNotExist404`)
...
.get(`/market/priceoverview?currency=${Currency.EUR}&appid=${Application.CSGO}&market_hash_name=SecondItem`)
.reply(200, {
    success: true,
    lowest_price: '2,00€',
    volume: '612',
